package br.com.samy.helpdesk.controller;
...
import br.com.samy.helpdesk.dto.Summary;
import br.com.samy.helpdesk.entity.ChangesStatus;
import br.com.samy.helpdesk.entity.Ticket;
import br.com.samy.helpdesk.entity.User;
import br.com.samy.helpdesk.enuns.ProfileEnum;
import br.com.samy.helpdesk.enuns.StatusEnum;
import br.com.samy.helpdesk.security.jwt.JwtTokenUtil;
import br.com.samy.helpdesk.security.response.Response;
import br.com.samy.helpdesk.service.TicketService;
import br.com.samy.helpdesk.service.UserService;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> findById(@PathVariable("id") String id) {
		...
		for (Iterator<ChangesStatus> iterator = changesCurrent.iterator(); iterator.hasNext();) {
			ChangesStatus changeStatus = iterator.next();
	...
	public ResponseEntity<Response<Ticket>> changeStatus(
		...
		try {
			...
			ChangesStatus changeStatus = new ChangesStatus();
			changeStatus.setUser(userFromRequest(request));
			changeStatus.setDateChanges(new Date());
	...
	public ResponseEntity<Response<Summary>> findChart() {
		...
		chart.setAmountDisaproved(amountDisapproved);
		chart.setAmountAssigned(amountAssigned);
		chart.setAmountClose(amountClosed);
